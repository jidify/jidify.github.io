...
Tous les _BeanPostProcessor_ seront appelés pour tous les instances de beans créées.
...
Par exemple, ce _BeanPostProcessor_ permet d'indiquer le "nom" et le "type" de chaque bean de l'ApplicationContext.
...
Avec Spring, cette _EntityManagerFactory_ sera construte et injectée dans l'application par une BeanFactory : l'_**[EntityManagerFactoryBean](http://docs.spring.io/spring/docs/current/javadoc-api/org/springframework/orm/jpa/AbstractEntityManagerFactoryBean.html)**_.
